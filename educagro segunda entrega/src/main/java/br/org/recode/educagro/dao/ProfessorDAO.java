...
public class ProfessorDAO {
	...
	public void save(Professor professor) {
		String sql = "INSERT INTO Professor (email, senha, nome) values(?, ?, ?)";
	...
	public List<Professor> getProfessores() {
		...
		try {
			...
			while (rset.next()) {
				...
				System.out.println(rset.getInt("id_professor"));
	...
	public Professor getProfessorById(int id) {
		...
		try {
			...
			professores.setId(Integer.parseInt(rset.getString("id_professor")));
