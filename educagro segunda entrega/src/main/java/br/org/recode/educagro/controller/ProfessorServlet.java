...
@WebServlet(urlPatterns = { "/professor", "/create-professor", "/edit-professor", "/update-professor",
		"/delet-professor" })
public class ProfessorServlet extends HttpServlet {
	...
	protected void edit(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("./views/professores/update.jsp");
		rd.forward(request, response);
	...
	protected void update(HttpServletRequest request, HttpServletResponse response)
		...
		Professor professor = new Professor(id,nome,email,senha);
