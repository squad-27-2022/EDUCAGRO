	...
	<!--NAVBAR-->
		...
		<!--FIM NAVBAR-->
		 <section class="container">
	     	...
	     	<div class="p-4">
			 	<a href="./views/materias/create.html" class="btn btn-primary mb-2 botao1">
		            Nova Materia
		        </a>
				<table class="table  table-hover">
				  ...
				  <%for(Materias materia : materias){ %>
				  	<tr>
				  		<td scope="col"><%=materia.getId_materia() %></td>
				  		<td scope="col"><%=materia.getNome() %></td>
				  		<td><a class="btn btn-warning" href="edit-materias?id=<%=materia.getId_materia() %>">EDITAR</a></td>
				  		<td><a class="btn btn-danger" href="delet-materias?id=<%=materia.getId_materia() %>">EXCLUIR</a></td>
				  	</tr>
				  	<%} %>
				  </tbody>
				</table>
