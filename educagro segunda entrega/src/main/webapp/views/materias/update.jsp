...
<title>Educ Agro | Atualizar Materia</title>
</head>
<body>
	<main>
		<header class="header">
		...
		<ul class="nav justify-content-center">
		  ...
		  <li class="nav-item">
		    <a class="nav-link" href="./materias">Materiass</a>
		  </li>
		  <li class="nav-item">
		...
		<div class="container py-3">
            <form action="./update-materias">
	            ...
	            <div class="form-group mb-3">
	                ...
	                value="<%=materia.getId_materia() %>" readonly/>
	            </div>
	            ...
	            <div class="form-group mb-3">
	                ...
	                value="<%=materia.getNome() %>" />
	            </div>
	
	            <button type="submit" class="btn btn-primary">
	                Enviar
	            </button>
	            <a href="./materias" class="btn btn-danger" style="margin-left: 10px">
	                Cancelar
	            </a>
            </form>
        </div>
