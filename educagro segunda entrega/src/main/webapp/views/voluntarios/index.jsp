...
<%
List<Voluntario> voluntarios = (List<Voluntario>) request.getAttribute("voluntario");
%>
...
<body>
	<!--NAVBAR-->
					...
					<div class="container-fluid">
						<div class="collapse navbar-collapse" id="ftco-nav">
							<ul class="navbar-nav m-auto">
								...
								<li class="nav-item active fs-5 fw-bold"><a
									href="./voluntario" class="nav-link">Voluntario</a></li>
								<li class="nav-item active fs-5 fw-bold"><a href="./index.html"
									class="nav-link" 
									>Sair</a></li>
							</ul>
						</div>
		...
		<section class="container">
			...
			<div class="p-4">
				<a href="./views/voluntarios/create.html"
					class="btn btn-primary mb-2 botao1"> Novo Voluntario </a>
				<table class="table  table-hover">
					<thead class="table-dark">
						<tr>
							...
							<th scope="col" colspan="2">Operaçoes</th>
						</tr>
					</thead>
					<tbody>
						<%
						...
						%>
						<tr>
							<td scope="col"><%=voluntario.getId_voluntario() %></td>
							<td scope="col"><%=voluntario.getNome() %></td>
							<td scope="col"><%=voluntario.getEmail()%></td>
							<td><a class="btn btn-warning" href="edit-voluntario?id=<%=voluntario.getId_voluntario()  %>">EDITAR</a></td>
							<td><a class="btn btn-danger" href="delet-voluntario?id=<%=voluntario.getId_voluntario() %>">EXCLUIR</a></td>
						</tr>
						<%
						}
						%>
